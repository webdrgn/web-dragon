  ...
  return (
    <div id="skills" className="skills">
      ...
      <div className="skills__content">
        ...
        >
          Frontend-дракончик с 4.5+ годами опыта, который превращает сложные
          задачи в элегантные решения. Прошёл путь от верстальщика до
          архитектора, но сохранил драконью страсть к созданию по-настоящему
          огненных интерфейсов.
        </p>
